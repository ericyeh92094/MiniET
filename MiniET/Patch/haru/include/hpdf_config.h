...
#define LIBHPDF_PACKAGE_BUGREPORT "@LIBHPDF_PACKAGE_BUGREPORT@"

/* Define to the full name of this package. */
#define LIBHPDF_PACKAGE_NAME "@LIBHPDF_PACKAGE_NAME@"

/* Define to the full name and version of this package. */
#define LIBHPDF_PACKAGE_STRING "@LIBHPDF_PACKAGE_STRING@"

/* Define to the one symbol short name of this package. */
#define LIBHPDF_PACKAGE_TARNAME "@LIBHPDF_PACKAGE_TARNAME@"

/* Define to the version of this package. */
#define LIBHPDF_PACKAGE_VERSION "@LIBHPDF_PACKAGE_VERSION@"

/* Define to 1 if you have the ANSI C header files. */
#define LIBHPDF_STDC_HEADERS

/* Define to `unsigned int' if <sys/types.h> does not define. */
#define LIBHPDF_size_t @LIBHPDF_size_t@
